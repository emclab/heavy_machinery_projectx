module HeavyMachineryProjectx
  class Project < ActiveRecord::Base
    ...
    attr_accessor :awarded_noupdate, :cancelled_noupdate, :completed_noupdate, :customer_name
    attr_accessible :awarded, :cancelled, :completed, :construction_requirement, :customer_id, :install_address, :last_updated_by_id, :name, :other_spec, 
                    ...
                    :test_run_date, :turn_over_date, :bid_doc_available_date, :bid_deadline, :tender_open_date, :qty, :project_num,
                    :customer_name,
                    :as => :role_new
    attr_accessible :awarded, :cancelled, :completed, :construction_requirement, :customer_id, :install_address, :last_updated_by_id, :name, :other_spec, 
                    :project_manager_id, :status_id, :tech_spec, :turn_over_requirement, :design_start_date, :production_start_date, :install_start_date,
                    :test_run_date, :turn_over_date, :bid_doc_available_date, :bid_deadline, :tender_open_date, :qty,
